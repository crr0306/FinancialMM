========================================================================
    ACTIVEX CONTROL DLL : FinancialMM Project Overview
========================================================================

ControlWizard has created this project for your FinancialMM ActiveX Control
...
that make up your FinancialMM ActiveX Control DLL.
...
FinancialMM.ico
    ...
    is included by the main resource file FinancialMM.rc.

/////////////////////////////////////////////////////////////////////////////
CFinancialMMCtrl control:

FinancialMMCtrl.h
    This file contains the declaration of the CFinancialMMCtrl C++ class.

FinancialMMCtrl.cpp
    This file contains the implementation of the CFinancialMMCtrl C++ class.

FinancialMMPropPage.h
    This file contains the declaration of the CFinancialMMPropPage C++ class.

FinancialMMPropPage.cpp
    This file contains the implementation of the CFinancialMMPropPage C++ class.

CFinancialMMCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CFinancialMMCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file FinancialMM.rc.
...
stdafx.h, stdafx.cpp
    ...
    named FinancialMM.pch and a precompiled types (PCT) file named stdafx.obj.
